...
# Fit the RSFs ###
rsf <- ctmm:::rsf.fit(l[[1]], UD=ud, R=list(pasture=pasture,nf=nf,pf=pf,stream=stream), formula=~pasture+nf+pf+stream+pasture:temp_c+nf:temp_c+pf:temp_c+stream:temp_c, debias=TRUE, error=0.05)
print("Fitted RSF")
